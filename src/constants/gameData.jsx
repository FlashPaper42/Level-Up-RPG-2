export const BASE_ASSETS = {
    skillIcons: { 'Reading': '/assets/skills/reading_icon.gif', 'Math': '/assets/skills/math_icon.png', 'Writing': '/assets/skills/writing_icon.png', 'Cleaning': '/assets/skills/cleaning_icon.gif', 'Memory': '/assets/skills/axolotl_blue.gif', 'Patterns': '/assets/skills/pattern_icon.png' },

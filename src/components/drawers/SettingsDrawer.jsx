...
const SettingsDrawer = ({ isOpen, activeTheme, setActiveTheme, onReset, bgmVol, setBgmVol, sfxVol, setSfxVol, currentProfile, onSwitchProfile, profileNames, onRenameProfile, getProfileStats, parentStatus, onParentVerified, currentSkills }) => (
    <div 
    ...
    >
        <div className="p-6 h-full flex flex-col justify-evenly gap-6 overflow-y-auto scrollbar-hide text-slate-200 font-sans">
            ...
            <div>
                <h3 className="text-xl text-blue-300 mb-5 font-bold flex items-center gap-3 uppercase tracking-wider"><Sparkles size={20} /> Theme Select</h3>

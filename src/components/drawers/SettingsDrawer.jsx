...
const SettingsDrawer = ({ isOpen, onClose, activeTheme, setActiveTheme, onReset, bgmVol, setBgmVol, sfxVol, setSfxVol, currentProfile, onSwitchProfile, profileNames, onRenameProfile, getProfileStats }) => (
    <div 
        ...
        style={{ top: 0, left: 0 }}
    >
        <div className="p-6 h-full flex flex-col min-h-full overflow-y-auto scrollbar-hide text-slate-200 font-sans">
            <div className="flex justify-between items-center mb-5 border-b-2 border-slate-700 pb-4">
            ...
            <div className="mb-8">
                ...
                <div className="space-y-4 bg-slate-900/50 p-4 rounded-xl border-2 border-slate-600">
                    <div>
